...
def initSecret(mots) :
    ...
    secretWord = mots[random.randint(0,len(mots)-1)];#On choisi un mot random
...
try :
    cheminMots = open(sys.argv[1], "r", encoding = "utf8");
    lignes = cheminMots.readlines();
    ...
    print("Heureusement qu'on a une liste de secours...");
    initSecret(mots);
